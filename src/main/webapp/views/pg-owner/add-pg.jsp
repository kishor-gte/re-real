...
<head>
    ...
    <title>Add PG Property | EstateVault</title>
...
<div class="pgo-dashboard-wrap">
    ...
    <div class="pgo-main">
        <header class="pgo-topbar">
            <h2 class="pgo-topbar-title">Add <span>PG Property</span></h2>
...
document.addEventListener('DOMContentLoaded', function () {
    PgPropertyUI.initWizard('${ctx}', { editMode: false, propertyId: null });
});
</script>

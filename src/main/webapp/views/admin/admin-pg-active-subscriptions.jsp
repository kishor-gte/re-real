...
<head>
    ...
    <title>Active PG Subscriptions | Admin</title>
...
<div class="admin-dashboard-wrap">
    ...
    <div class="admin-main">
        <header class="admin-topbar"><h2 class="admin-topbar-title">Active PG <span>Subscriptions</span></h2></header>
...
<script>AdminPgSubscription.init('${ctx}', 'active');</script>

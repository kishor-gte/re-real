...
<head>
    ...
    <title>Active Subscriptions | Admin</title>
...
<div class="admin-dashboard-wrap">
    ...
    <div class="admin-main">
        <header class="admin-topbar"><h2 class="admin-topbar-title">Active <span>Subscriptions</span></h2></header>
...
<script>AdminSubscription.init('${ctx}', 'active');</script>

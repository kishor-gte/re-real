...
public class PublicPropertyDetailResponse {
	...
	private String listingTypeLabel;
	...
	public void setListingTypeLabel(String listingTypeLabel) {
	...
	public void setFurnishingLabel(String furnishingLabel) {
	...
	public String getCommercialTypeLabel() {
		return commercialTypeLabel;
	}

	public void setCommercialTypeLabel(String commercialTypeLabel) {
		this.commercialTypeLabel = commercialTypeLabel;
	}
	...
	public String getLandUseLabel() {
		return landUseLabel;
	}

	public void setLandUseLabel(String landUseLabel) {
		this.landUseLabel = landUseLabel;
	}
	...
	public String getConstructionStatusLabel() {
		return constructionStatusLabel;
	}

	public void setConstructionStatusLabel(String constructionStatusLabel) {
